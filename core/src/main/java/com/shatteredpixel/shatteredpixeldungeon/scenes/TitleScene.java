...
import com.elkazajo.lastcaravan.scout.ScoutGameStart;
...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		if (landscape()) {
			...
			btnRankings.setRect(btnPlay.left(), btnPlay.bottom() + GAP, (float) (Math.floor(buttonAreaWidth / 3f) - 1),
					BTN_HEIGHT);
